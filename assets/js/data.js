...
window.DATA_VERSION = '2026-09-21.1';
...
/* ---------- 政策智库（基于真实政策文件）---------- */
const POLICIES = [
  {id:'pol_weiduanju', title:'《微短剧发展管理办法》', docNo:'国家广播电视总局令第16号',
   dept:'国家广播电视总局', pubDate:'2026-07-30', effDate:'2026-09-01', status:'现行有效', updatedAt:upd(0),
   ...
   source:{source_name:'国家广播电视总局', source_url:'https://www.nrta.gov.cn/art/2026/7/31/art_1588_73827.html', publisher:'国家广播电视总局', published_at:'2026-07-30', fetched_at:mins(0), status:'ok', last_checked_at:mins(0)},
   official:'https://www.nrta.gov.cn/art/2026/7/31/art_1588_73827.html',
  },
  {id:'pol_jingpin', title:'微短剧精品创作传播计划"五个一批工程"', docNo:'广电总局网络视听节目管理司',
   ...
   source:{source_name:'国家广播电视总局', source_url:'https://www.nrta.gov.cn/art/2026/9/1/art_114_73989.html', publisher:'国家广播电视总局', published_at:'2026-08-27', fetched_at:mins(0), status:'ok', last_checked_at:mins(0)},
  ...
  {id:'pol_beijing_ai', title:'北京市推动"人工智能+文化和旅游"发展行动计划（2026—2028 年）', docNo:'京文旅〔2026〕',
   dept:'北京市文化和旅游局', pubDate:'2026-06-04', effDate:'2026-06-04', status:'现行有效', updatedAt:upd(0),
   ...
   source:{source_name:'文化和旅游部', source_url:'https://mct.gov.cn/wlbphone/wlbydd/xxfb/qglb/202606/t20260604_966115.html', publisher:'北京市文化和旅游局', published_at:'2026-06-04', fetched_at:mins(0), status:'ok', last_checked_at:mins(0)},
  ...
  {id:'pol_jiangsu_ai', title:'江苏省"人工智能+文化旅游"行动方案（2026—2028 年）', docNo:'苏文旅〔2026〕',
   dept:'江苏省文化和旅游厅', pubDate:'2026-05-11', effDate:'2026-05-11', status:'现行有效', updatedAt:upd(0),
   ...
   source:{source_name:'文化和旅游部', source_url:'https://www.mct.gov.cn/wlbphone/wlbydd/xxfb/qglb/qg/202605/t20260511_965766.html', publisher:'江苏省文化和旅游厅', published_at:'2026-05-11', fetched_at:mins(0), status:'ok', last_checked_at:mins(0)},
   official:'https://www.mct.gov.cn/wlbphone/wlbydd/xxfb/qglb/qg/202605/t20260511_965766.html',
  },
  {id:'pol_consume', title:'关于进一步培育新增长点繁荣文化和旅游消费的若干措施', docNo:'文化和旅游部等·繁荣文旅消费若干措施',
   ...
   source:{source_name:'中国经济网', source_url:'https://www.ce.cn/xwzx/gnsz/gdxw/202608/t20260827_3172342.shtml', publisher:'文化和旅游部', published_at:'2026-08-27', fetched_at:mins(0), status:'ok', last_checked_at:mins(0)},
   official:'https://www.ce.cn/xwzx/gnsz/gdxw/202608/t20260827_3172342.shtml',
  },
  {id:'pol_15th', title:'"十五五"文化发展规划纲要', docNo:'中办发〔2026〕6号',
   dept:'中共中央办公厅、国务院办公厅', pubDate:'2026-03-20', effDate:'2026-03-20', status:'现行有效', updatedAt:upd(0),
   ...
   source:{source_name:'中国政府网', source_url:'https://www.gov.cn', publisher:'国务院办公厅', published_at:'2026-03-20', fetched_at:mins(0), status:'ok', last_checked_at:mins(0)},
   official:'https://www.gov.cn',
  },
  {id:'pol_gd_tips', title:'广电总局发布微短剧管理提示：9 月 1 日起全面实施三级监管', docNo:'广电总局·微短剧管理提示（2026）',
   dept:'国家广播电视总局', pubDate:'2026-09-01', effDate:'2026-09-01', status:'现行有效', updatedAt:upd(0),
   tags:['微短剧监管','三级审核','AI 微短剧','互动微短剧','分类管理'], level:'国家',
   aiSummary:'总局发布微短剧管理提示，自 9 月 1 日起全面实施三级监管：一类（大投资/特殊题材）、二类、三类微短剧分类审核；互动微短剧按核心内容制作方式划分；AI 生成核心内容的执行 AI 微短剧分类标准。法律效力层级高于行业指引，标志微短剧监管从阶段性引导转向制度化、法治化长效治理。',
   clauses:['一类微短剧：投资较大或涉及政治、军事、外交等特殊题材，从严审核','二类/三类：投资不大、一般题材，由网络视听平台履行主体责任，播前审核并标注节目编号后上线','互动微短剧按核心内容制作方式划分：真人为主执行真人标准，AI 生成为主执行 AI 微短剧标准','各平台完成播前内容审核并标注节目编号，方可安排上线播出'],
   impact:'与《微短剧发展管理办法》（总局令第 16 号）配套落地，9/1 起监管从阶段性引导转向制度化、法治化长效治理。',
   support:'总局统筹，各省级广电主管部门落地细则与培训，统一标识（苔花灵感）同步启用。',
   related:[{n:'《微短剧发展管理办法》',id:'pol_weiduanju'}],
   source:{source_name:'广东省广播电视局', source_url:'https://gbdsj.gd.gov.cn/zxzx/hydt/content/post_4944548.html', publisher:'国家广播电视总局', published_at:'2026-09-01', fetched_at:mins(0), status:'ok', last_checked_at:mins(0)},
   official:'https://gbdsj.gd.gov.cn/zxzx/hydt/content/post_4944548.html',
  },
];
